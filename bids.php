							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<?php else: ?>
										<span class="badge badge-failure" style="background-color: red; color: white">Defeat</span>
										<?php endif; ?>
										<?php endif; ?>
									...
									<td>
										<button class="btn btn-primary btn-sm view_user" type="button" style="display: flex; justify-contents: center; align-items: center" data-id ='<?php echo $row['user_id'] ?>'>View Buyer Details</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
